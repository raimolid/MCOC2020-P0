...
from matrices_laplacianas import matriz_laplaciana_llena 
...
for i in range(Ncorridas):
    ...
    for N in Ns:
        ...
        t2=perf_counter()
        C=spLinalg.solve(A,B,assume_a="pos")
        t3=perf_counter() 
...
plt.title("Complejidad Solve Matriz Llena", fontsize=10)
