...
#CREANDO ARCHIVO D TEXTO 
dts=[]
mem=[]
name=("timing_caso_3_longdouble.txt")
fid=open(name,"w")
...
plt.plot(tamano,tiempo,marker="o",color="red")
plt.loglog(tamano,tiempo,marker="o",color="red")
...
plt.plot(tamano, memoria,marker="o",color="red")
plt.loglog(tamano,memoria,marker="o",color="red")
